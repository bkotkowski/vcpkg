...
/* 0 */
EXTERN critcl_callback_p critcl_callback_new(Tcl_Interp*interp, int objc,
				Tcl_Obj**objv, int nargs);
/* 1 */
...
typedef struct Critcl_callbackStubs {
    ...
    critcl_callback_p (*critcl_callback_new) (Tcl_Interp*interp, int objc, Tcl_Obj**objv, int nargs); /* 0 */
    ...
    int (*critcl_callback_invoke) (critcl_callback_p callback, int objc, Tcl_Obj**objv); /* 3 */
