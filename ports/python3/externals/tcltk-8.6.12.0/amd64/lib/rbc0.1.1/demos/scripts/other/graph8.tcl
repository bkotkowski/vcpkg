# ------------------------------------------------------------------------------
#  RBC Demos - file demos/scripts/graph8.tcl (alternative sourced file)
# ------------------------------------------------------------------------------
#  This file is a script fragment that can be sourced by the demo
#  demos/graph1.tcl in place of demos/scripts/graph1.tcl.
#
# Comparison with demos/scripts/graph1.tcl
# - Either file may be used by demos/graph1.tcl to provide data and
#   configuration.
# - Different values are set as defaults in the options database.
# - Data series Y1, Y2, Y3 cyclically permuted.
# - Data series Y1 ("line 3") and one BLT texture are obscured if this
#   file is used in place of demos/scripts/graph1.tcl.
#
# This may be a snapshot of a work in progress that was eventually
# incorporated into demos/scripts/graph1.tcl.
# ------------------------------------------------------------------------------
...
$graph configure -width 4i -height 5i
