# ------------------------------------------------------------------------------
#  RBC Demos - file demos/scripts/graph5.tcl (script fragment)
# ------------------------------------------------------------------------------
# Comparison with demos/graph5.tcl
# - Much supporting code is missing (footer, definition of graph,
#   mapping of widgets).
# - Different values are set as defaults in the options database.
# - A smaller dataset is used (10 symbols not 11)
# - There are no significant differences from demos/graph5.tcl
#
# This file may be a snapshot of a work in progress that was eventually
# incorporated into demos/graph5.tcl.
# ------------------------------------------------------------------------------
