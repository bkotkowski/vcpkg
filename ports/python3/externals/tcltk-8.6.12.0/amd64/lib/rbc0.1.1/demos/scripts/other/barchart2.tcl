# ------------------------------------------------------------------------------
#  RBC Demo - file demos/scripts/barchart2.tcl (script fragment)
# ------------------------------------------------------------------------------
# Comparison with demos/barchart2.tcl
# - Much supporting code is missing (header, footer, definition of barchart,
#   mapping of widgets).
# - Different values are set as defaults in the options database.
# - Different background image.
# - Different colors.
# - Uses 4x4 stipple patterns not 8x8, although the result is the same.
# - Otherwise the same.
#
# This may be a snapshot of a work in progress that was eventually
# incorporated into demos/barchart2.tcl.
# ------------------------------------------------------------------------------
...
set attributes { 
    "Load"	Y2	white	 	white3		pattern2		0
