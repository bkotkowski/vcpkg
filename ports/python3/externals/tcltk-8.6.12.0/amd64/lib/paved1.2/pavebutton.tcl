package provide Paved::button 1.2
...
#
# How to use Paved::button:
#   Read "pavebutton.txt" for detailed info.
#   Sample code in provided in "demo*.tcl".
#


::snit::widgetadaptor Paved::button {
   ...
   typeconstructor {
      bind PavedButton <Configure> { %W _RedrawBg %w %h }
   }
   ...
   constructor {args} {
      ...
      bindtags $win [linsert [bindtags $win] 1 PavedButton]
   }
...
proc Paved::buttonAdaptor {path args} {
   Paved::button adapt $path {*}$args
   return $path
}
