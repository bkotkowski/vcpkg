...
declare 0 generic {
    critcl_callback_p critcl_callback_new (Tcl_Interp* interp, int objc, Tcl_Obj** objv, int nargs)
}
...
declare 3 generic {
    int critcl_callback_invoke (critcl_callback_p callback, int objc, Tcl_Obj** objv)
}
